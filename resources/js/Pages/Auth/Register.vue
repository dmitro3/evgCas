...
const handleCheckPromo = async () => {
    exist.value = null;
    exist.value = await existPromo(form.value.promocode);
}
                    ...
                    <div class="py-8 flex flex-col w-full gap-6">
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            <div style="padding: 12px;" class="main-input flex gap-2" :class="{ 'border-red-primary': authStore?.errors?.promocode }">
                                ...
                                <button type="button" @click="handleCheckPromo" :class="exist === null ? 'bg-primary' : exist ? 'btn-success' : 'btn-danger shake'" class="btn px-0 py-0 flex items-center justify-center h-7 w-8">
