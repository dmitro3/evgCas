    ...
    <section class="flex flex-col gap-12">
                ...
                <div class="bg-secondary-sidebar bonus-bg md:items-center md:justify-center bonus-bg-mobile flex w-full rounded-2xl">
                    <div class="flex flex-col gap-5 pl-6 py-6 h-full max-w-[250px] w-full">
                        ...
                        <div class="main-input-small flex gap-2">
                            ...
                            <button ref="promoButton" @click="handleActivatePromo" class="btn btn-primary flex justify-center items-center px-0 py-0 w-8 h-7">
                ...
                <div class="bg-secondary-sidebar max-md:flex-col md:items-center flex gap-6 p-4 rounded-2xl">
                    ...
                    <div class="flex flex-col gap-8 w-full">
                        ...
                        <div class="flex flex-col gap-2 uppercase">
                            ...
                            <div class="text-secondary-light/50 flex justify-between items-center w-full text-sm font-semibold">
        ...
        <div class="container flex flex-col gap-6 px-5 mx-auto w-full">
            <div class="flex flex-col gap-2.5">
                ...
                <div class="bg-secondary-sidebar flex flex-col gap-6 p-8 w-full rounded-xl" v-if="faqTab === 'privileges'">
                    ...
                    <!-- Description -->
                    <div class="text-secondary-light/75 leading-relaxed">
                        <p class="mb-4">
                ...
                <div class="flex flex-col gap-3 w-full" v-if="faqTab === 'main'">
                    <div class="bg-secondary-sidebar flex flex-col gap-6 p-8 w-full rounded-xl">
                        ...
                        <div class="text-secondary-light/75 leading-relaxed">
                            <FaqItem class="bg-[#222C51]" :question="'About affilate programm'" :answer="`Since 2019, Domen has been a leader in the online gambling industry, offering players around the world a wide range of original games and slots. Our platform, characterized by reliability, security and a decentralized structure, provides unique opportunities for betting on cryptocurrency in online slots and exclusive Domain Originals games.

                            We regularly hold promotions and bonus programs for our users, as well as offer a unique experience of participating in the VIP club. Our licensed platform provides a simple and convenient deposit process, absolute transparency of gaming coefficients and a decentralized structure, which guarantees fair play, fast withdrawals and full protection of our clients' data and assets.`" />
                        </div>
