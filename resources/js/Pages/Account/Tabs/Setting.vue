...
<template>
    <div class="flex flex-col gap-12">
        ...
        <div class="md:grid-cols-2 grid gap-2.5">
            ...
            <form @submit.prevent="handleUpdatePassword" class="bg-secondary-sidebar flex flex-col flex-1 gap-6 p-6 w-full rounded-2xl">
                <div class="flex gap-2.5 items-center">
                    <div class="tag tag-primary flex justify-center items-center w-10 h-10">
