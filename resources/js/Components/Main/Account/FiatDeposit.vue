        ...
        <div class="flex flex-col gap-5 w-full">
            <div class="flex flex-col gap-2">
                ...
                <VueSelect
                    ...
                    v-model="selected"
                    :options="options"
                    placeholder="Select a merchant for deposit"
            ...
            <div class="flex flex-col gap-2">
                ...
                <div class="main-input-small">
                    <input
                        type="number"
                        v-model="amount"
                        :placeholder="`Min ${props.wallet.min_deposit} ${props.wallet.symbol}`"
            ...
            <div class="bg-blue-500/10 border-blue-500/20 flex gap-3 p-4 rounded-lg border">
                <div class="flex flex-shrink-0 justify-center items-center w-6 h-6 bg-blue-500 rounded-full">
                    <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M6 0C2.7 0 0 2.7 0 6s2.7 6 6 6 6-2.7 6-6-2.7-6-6-6zm0 9c-.6 0-1-.4-1-1s.4-1 1-1 1 .4 1 1-.4 1-1 1zm1-3H5V3h2v3z" fill="white"/>
                    </svg>
                </div>
                <div class="flex flex-col gap-1">
                    <div class="text-sm font-bold text-blue-400">WARNING</div>
                    <div class="text-secondary-light/70 text-sm">
            ...
            <div class="flex flex-col gap-2">
                ...
                <div class="main-input-small !bg-secondary py-0.5 pr-0.5">
                    ...
                    <button
                        ...
                        @click="copyText(props.wallet.address)"
                    >
                        <svg
            ...
            <button
                ...
                :disabled="!isValidAmount || !selected"
                class="btn btn-primary justify-center py-4 w-full font-bold text-center transition-all duration-300"
                :class="{ 'opacity-50 cursor-not-allowed': !isValidAmount || !selected }"
            >
